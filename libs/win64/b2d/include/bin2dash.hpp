...
struct StreamDesc {
    ...
    uint32_t tileNumber;    // objectX, officially. In MCU, for pointclouds, we use this field for tileNumber
    uint32_t quality;    // objectY, officially. In MCU, for pointclouds, we use this field for quality
